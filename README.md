...
#### Windows
You can run Dobby as a Java program from command prompt. Java JRE 11 is required. To grab the latest Dobby JAR, navigate to the Actions tab above, select the latest workflow, and download the artifact at the bottom. Run the JAR using this command.
```
